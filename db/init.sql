CREATE ROLE repl_user WITH REPLICATION LOGIN ENCRYPTED PASSWORD 'Qq123456';
...
CREATE TABLE IF NOT EXISTS phone_numbers(id SERIAL PRIMARY KEY, phone_number VARCHAR(70) NOT NULL);
